var sleep, brush, bg, gym, eat, drink, move, astronaut;
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("To brush: press up arrow. To use the gym: press down arrow. To eat: press left arrow. To bath: press right arrow. To move: press m button.",300,30);
}